...
@DiscriminatorValue(value="-89999999999726")
public abstract class ItemBaixaPedidoAbstrato extends ItemOperacao implements InterfaceItemOperacao {
	...
	private ItemPedido pedidoBaixado;
	...
	public void setPedidoBaixado(ItemPedido pedidoBaixado) {
		this.pedidoBaixado = pedidoBaixado;
	}
	public ItemPedido getPedidoBaixado() {
		return pedidoBaixado;
	}
