...
@DiscriminatorValue(value="-89999999999316")
public class DefinicaoLancamentoFiscalCOFINS extends DefinicaoLancamentoFiscal {
	
	@ManyToOne(fetch=FetchType.LAZY)
	@JoinColumn(name="regraLancamentoFiscalCOFINSId")
	private RegraLancamentoFiscalCOFINS regraLancamentoFiscalCOFINS;
	...
	public RegraLancamentoFiscalCOFINS getRegraLancamentoFiscalCOFINS() {
		return regraLancamentoFiscalCOFINS;
	}

	public void setRegraLancamentoFiscalCOFINS(
			RegraLancamentoFiscalCOFINS regraLancamentoFiscalCOFINS) {
		this.regraLancamentoFiscalCOFINS = regraLancamentoFiscalCOFINS;
	}
